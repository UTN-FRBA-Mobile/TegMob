...
var paises_limitrofes = {
	...
	'chile': ['argentina', 'Australia', 'madagascar', 'peru'],
	'China': ['Gobi', 'India', 'Iran', 'Japon', 'Kamchatka', 'Malasia', 'Mongolia', 'Siberia'],
	'colombia': ['brazil', 'egypt', 'Mexico', 'peru'],
	'egypt': ['colombia', 'ethiopia', 'Israel', 'madagascar', 'sahara', 'Polonia', 'Turquia'],
	...
	'madagascar': ['chile', 'egypt', 'southafrica', 'zaire'],
	...
	'southafrica': ['ethiopia', 'madagascar', 'zaire'],
	...
	'zaire': ['ethiopia', 'sahara', 'southafrica'],
}